...
class Ui_PreferencesDialog(object):
    def setupUi(self, PreferencesDialog):
        ...
        PreferencesDialog.resize(365, 241)
        ...
        self.spinBoxRefreshRate.setMaximum(1000)
        ...
        self.labelGraphLineWidth = QtWidgets.QLabel(PreferencesDialog)
        self.labelGraphLineWidth.setObjectName("labelGraphLineWidth")
        self.horizontalLayout_5.addWidget(self.labelGraphLineWidth)
        self.spinBoxGraphLineWidth = QtWidgets.QSpinBox(PreferencesDialog)
        self.spinBoxGraphLineWidth.setMinimum(1)
        self.spinBoxGraphLineWidth.setMaximum(10)
        self.spinBoxGraphLineWidth.setObjectName("spinBoxGraphLineWidth")
        self.horizontalLayout_5.addWidget(self.spinBoxGraphLineWidth)
        ...
        self.labelTheme = QtWidgets.QLabel(PreferencesDialog)
        self.labelTheme.setObjectName("labelTheme")
        self.horizontalLayout_4.addWidget(self.labelTheme)
        delegate = QtWidgets.QStyledItemDelegate()
    ...
    def retranslateUi(self, PreferencesDialog):
        ...
        self.labelGraphLineWidth.setText(_translate("PreferencesDialog", "Graph Line Width:"))
        self.labelFont.setText(_translate("PreferencesDialog", "Font:"))
        self.label.setText(_translate("PreferencesDialog", "Size:"))
        self.labelTheme.setText(_translate("PreferencesDialog", "App Theme:"))
